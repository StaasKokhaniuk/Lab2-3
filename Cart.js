    ...
    cartItems.forEach(function(item) {
        ...
        cartItem.innerHTML = `
            ...
            <div class="cart-item-details">
                ...
                <p style="color:white">${item.price} x ${item.quantity}</p>
                <button onclick="increaseQuantity(${item.id})" style="color:white">+</button>
                <button onclick="decreaseQuantity(${item.id})" style="color:white">-</button>
            </div>
        `;
